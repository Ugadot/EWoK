...
class Workspace(object):
    def __init__(self, cfg):
        ...
        assert "task_kwargs" in cfg.env.train
        self.perturbed_values = np.linspace(
            cfg.env.train.task_kwargs.perturb_spec.min,
            cfg.env.train.task_kwargs.perturb_spec.max,
    ...
    def run_evaluate(self):
        ...
        for step, value in enumerate(self.perturbed_values):
            self.cfg.env.train.task_kwargs.perturb_spec.start = value
            test_env = make_env(self.cfg.env.train)
