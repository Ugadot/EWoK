...
AGENT_TRAIN_FORMAT = {
    "sac": [
        ...
        ("critic_maxQ", "MAXQ", "float"),
        ("critic_minQ", "MINQ", "float"),
        ("critic_avgQ", "AVGQ", "float"),
    ...
    "rsac": [
        ...
        ("actor_loss", "ALOSS", "float"),
        ("critic_loss", "CLOSS", "float"),
        ("critic_maxcoeff", "MAXCOEFF", "float"),
        ("critic_mincoeff", "MINCOEFF", "float"),
        ("critic_avgcoeff", "AVGCOEFF", "float"),
        ("critic_maxQ", "MAXQ", "float"),
        ("critic_minQ", "MINQ", "float"),
        ("critic_avgQ", "AVGQ", "float"),
        ("alpha_loss", "TLOSS", "float"),
